...
class _TelaCadastroViewState extends State<TelaCadastroView>{
          ...
          child:Column(
            children: [
              ...
              TextFormField(
                ...
                validator: (value) => value!.isEmpty ? null : "Insira um Nome", //Operador Ternário
  ...
  void _enviarDados() {
    if(_formKey.currentState!.validate() && _aceiteTermos){
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Você Precisa Aceitar os Termos")));
    }
  }
}