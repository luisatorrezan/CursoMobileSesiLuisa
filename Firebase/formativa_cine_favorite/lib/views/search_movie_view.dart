...
import 'package:formativa_cine_favorite/controllers/firestore_controller.dart' as fc;
...
class _SearchMovieViewState extends State<SearchMovieView> {
  //atributos
  final _firestoreController = fc.FirestoreController();
  final _searchField = TextEditingController();

  List<Map<String,dynamic>> _searchResults = [];
  bool _isLoading = false;
  
  get TmdbController => null;
                  ...
                  return ListTile(
                    ...
                    trailing: IconButton(
                      onPressed: ()async{
                        ...
                        Navigator.pop(context); //volto apra tela de Favoritos
                      }, 
                      icon: Icon(Icons.add)),
                  );
